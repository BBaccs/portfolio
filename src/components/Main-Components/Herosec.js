        ...
        <div className="custom-container">
            <div className="hero-content content-width">
                <div className="section-header">
                    ...
                    <h1 className="scroll-animation" data-aos='fade-up'><span>Brian Baccarella's</span> UI Developer Portfolio</h1>
                </div>
                <p className="scroll-animation" data-aos='fade-up'>I develop beautiful, accessible, User Interfaces.</p>
                <a href="#portfolio" 
                ...
                <div className="facts d-flex">
                    <div className="left scroll-animation" data-aos='fade-right'>
                        <h1>5+</h1>
                        <p>Years of professional<br/>Experience</p>
                    </div>
                    <div className="right scroll-animation" data-aos='fade-left'>
                        <h1>6+</h1>
                        <p>of coding <br/>experience</p>
                    </div>
                </div>
            </div>
        </div>
