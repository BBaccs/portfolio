            ...
            <div className="custom-container">
                <div className="testimonial-content content-width">
                    <div className="section-header">
                        ...
                        <h1 className="scroll-animation" data-aos='fade-up'>Trusted by <span>Co workers</span></h1>
                    </div>    
                            ...
                            <div className="testimonial-item">
                                <div className="testimonial-item-inner">
                                    <div className="author d-flex align-items-center">
                                        ...
                                        <div className="right">
                                            <h3>Niroshan Paypoe</h3>
                                            <p className="designation">Developer III <span>Bloomin' Brands</span></p>
                                        </div>
                                    </div>
                            ...
                            <div className="testimonial-item">
                                <div className="testimonial-item-inner">
                                    <div className="author d-flex align-items-center">
                                        ...
                                        <div className="right">
                                            <h3>Gail Seanor</h3>
                                            <p className="designation">VP of digital<span>Bloomin' Brands</span></p>
                                        </div>
                                    </div>
                            ...
                            <div className="testimonial-item">
                                <div className="testimonial-item-inner">
                                    <div className="author d-flex align-items-center">
                                        ...
                                        <div className="right">
                                            <h3>Gail Seanor</h3>
                                            <p className="designation">Anthony DeCruze<span>Bloomin' Brands</span></p>
                                        </div>
                                    </div>
                                    <p>“Extremely profressional and fast service!. Drake is a master
                                        of code and he also very creative. We done 3 projects with
                            ...
                            <div className="testimonial-item">
                                <div className="testimonial-item-inner">
                                    <div className="author d-flex align-items-center">
                                        ...
                                        <div className="right">
                                            <h3>Gail Seanor</h3>
                                            <p className="designation">Caio Fernadez?<span>Bloomin' Brands</span></p>
                                        </div>
                                    </div>
                                    <p>“Extremely profressional and fast service!. Drake is a master
                                        of code and he also very creative. We done 3 projects with
