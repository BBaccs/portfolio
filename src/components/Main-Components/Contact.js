...
export default function Contact() {
  ...
  return (
    <section className="contact-area page-section scroll-content mt-5" id="contact">
        <div className="custom-container">
            <div className="contact-content content-width">
                <div className="section-header">
                    ...
                    <h1 className="scroll-animation" data-aos='fade-up'>Am <span>I</span> a good fit for your  <span>Team</span>?</h1>
                </div>
                <h3 className="scroll-animation" data-aos='fade-up'>baccarellab@gmail.com</h3>
                    ...
                    <div className="row">
                        <div className="col-md-6">
                            <div className="input-group">
                                ...
                                <input style={{ color: 'white' }} type="text" name="full-name" id="full-name" placeholder="Your Full Name"/>
                            </div>
                        </div>
                        <div className="col-md-6">
                            <div className="input-group">
                        ...
                        <div className="col-md-6">
                            <div className="input-group">
                                ...
                                <select name="subject" id="subject">
                                    ...
                                    <option value="subject1">Recruiter</option>
                                    <option value="subject2">Employer</option>
                                </select>
                            </div>
                        </div>
