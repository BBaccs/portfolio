            ...
            <div className="sidebar-menu-inner">
                ...
                <div className="sidebar-social">
                    ...
                    <ul className="social-links d-flex align-items-center">
                        <li>
                            <a aria-label="My GitHub" href="https://twitter.com"><i className="lab la-github"></i></a>
                        </li>
                        <li>
                            <a aria-label="My Linkedin"  href="https://dribble.com"><i className="lab la-linkedin"></i></a>
                        </li>
                        <li>
                            <a aria-label="My Coderbytes profile"  href="https://coderbyte.com/profile/bbaccz"><i className="la-sharp la-solid la-code"></i></a>
                        </li>
                    </ul>
                </div>
            </div>
